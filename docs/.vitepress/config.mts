    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '02 · New Copilot Studio Fundamentals', link: '/modules/02-copilot-studio-fundamentals/' },
          ...
          { text: '06 · Build the Helpdesk Agent (Bit)', link: '/modules/06-build-custom-agent/' },
          { text: '07 · Teach Bit Skills & Tools', link: '/modules/07-add-topic-with-triggers/' },
          { text: '08 · Enhance with Adaptive Cards', link: '/modules/08-enhance-with-adaptive-cards/' },
          { text: '09 · Automate Approvals with Workflows', link: '/modules/09-automate-with-agent-flows/' },
          { text: '10 · Autonomous Event Triggers', link: '/modules/10-add-event-triggers/' },
          { text: '11 · Evaluate, Publish & Monitor', link: '/modules/11-publish-your-agent/' },
